...
--------------------------------------------------------------------------------------
-- Demonstrate the following queries on the database:

-- a. Selecting data from one table (People)
SELECT * FROM People;

-- b. Selecting data from two or more tables using a JOIN condition (People and Schools)
